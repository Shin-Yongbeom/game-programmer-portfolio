...
가상의 대도시를 배경으로 한 3인칭 근접 액션 게임입니다. 1인 개발이며 AI 에이전트를 생산·검증
파이프라인에 통합해 진행 중입니다. 이 저장소에는 게임플레이 C#(약 15,800 LOC)와 시스템 설계
문서만 큐레이션해 담았습니다. 아트, 오디오, 모션, 씬, 스토리 문서는 제외했습니다.
